...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ee:	6a 54                	push   $0x54
     3f0:	e8 33 0f 00 00       	call   1328 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     424:	6a 18                	push   $0x18
     426:	e8 fd 0e 00 00       	call   1328 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     487:	6a 0c                	push   $0xc
     489:	e8 9a 0e 00 00       	call   1328 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4cf:	6a 0c                	push   $0xc
     4d1:	e8 52 0e 00 00       	call   1328 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     517:	6a 08                	push   $0x8
     519:	e8 0a 0e 00 00       	call   1328 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     575:	50                   	push   %eax
     576:	68 84 19 00 00       	push   $0x1984
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61d:	50                   	push   %eax
     61e:	68 84 19 00 00       	push   $0x1984
     ...
     63b:	50                   	push   %eax
     63c:	68 8c 19 00 00       	push   $0x198c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67e:	50                   	push   %eax
     67f:	68 84 19 00 00       	push   $0x1984
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c5:	50                   	push   %eax
     6c6:	68 84 19 00 00       	push   $0x1984
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     749:	68 72 14 00 00       	push   $0x1472
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     76b:	50                   	push   %eax
     76c:	68 73 14 00 00       	push   $0x1473
     771:	6a 02                	push   $0x2
     773:	e8 dc 08 00 00       	call   1054 <printf>
     778:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     77b:	83 ec 0c             	sub    $0xc,%esp
     77e:	68 82 14 00 00       	push   $0x1482
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e3:	68 89 14 00 00       	push   $0x1489
  ...
  if(peek(ps, es, ";")){
     ...
     7fd:	68 8b 14 00 00       	push   $0x148b
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86b:	68 8d 14 00 00       	push   $0x148d
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fa:	68 8f 14 00 00       	push   $0x148f
  ...
  while(peek(ps, es, "<>")){
     ...
     984:	68 ac 14 00 00       	push   $0x14ac
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9ad:	68 af 14 00 00       	push   $0x14af
    ...
    panic("parseblock");
     ...
     9c7:	68 b1 14 00 00       	push   $0x14b1
  ...
  if(!peek(ps, es, ")"))
     ...
     9fd:	68 bc 14 00 00       	push   $0x14bc
    ...
    panic("syntax - missing )");
     ...
     a17:	68 be 14 00 00       	push   $0x14be
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a5b:	68 af 14 00 00       	push   $0x14af
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae5:	68 82 14 00 00       	push   $0x1482
    ...
    if(argc >= MAXARGS)
     ...
     b1c:	68 d1 14 00 00       	push   $0x14d1
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b43:	68 df 14 00 00       	push   $0x14df
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba9:	8b 04 85 e4 14 00 00 	mov    0x14e4(,%eax,4),%eax
     bb0:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
     fa9:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
     fb0:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
     fb4:	74 17                	je     fcd <printint+0x2a>
     fb6:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     fba:	79 11                	jns    fcd <printint+0x2a>
    neg = 1;
     fbc:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
     fc3:	8b 45 0c             	mov    0xc(%ebp),%eax
     fc6:	f7 d8                	neg    %eax
     fc8:	89 45 ec             	mov    %eax,-0x14(%ebp)
     fcb:	eb 06                	jmp    fd3 <printint+0x30>
  } else {
    x = xx;
  ...
  i = 0;
     fd3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
     fda:	8b 4d 10             	mov    0x10(%ebp),%ecx
     fdd:	8b 45 ec             	mov    -0x14(%ebp),%eax
     fe0:	ba 00 00 00 00       	mov    $0x0,%edx
     fe5:	f7 f1                	div    %ecx
     fe7:	89 d1                	mov    %edx,%ecx
     fe9:	8b 45 f4             	mov    -0xc(%ebp),%eax
     fec:	8d 50 01             	lea    0x1(%eax),%edx
     fef:	89 55 f4             	mov    %edx,-0xc(%ebp)
     ff2:	0f b6 91 94 19 00 00 	movzbl 0x1994(%ecx),%edx
     ff9:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
     ffd:	8b 4d 10             	mov    0x10(%ebp),%ecx
    ...
    1011:	75 c7                	jne    fda <printint+0x37>
  if(neg)
    1013:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1017:	74 2d                	je     1046 <printint+0xa3>
    buf[i++] = '-';
    1019:	8b 45 f4             	mov    -0xc(%ebp),%eax
    101c:	8d 50 01             	lea    0x1(%eax),%edx
    101f:	89 55 f4             	mov    %edx,-0xc(%ebp)
    1022:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    1027:	eb 1d                	jmp    1046 <printint+0xa3>
    putc(fd, buf[i]);
    1029:	8d 55 dc             	lea    -0x24(%ebp),%edx
    ...
    103a:	50                   	push   %eax
    103b:	ff 75 08             	push   0x8(%ebp)
    103e:	e8 3d ff ff ff       	call   f80 <putc>
    1043:	83 c4 10             	add    $0x10,%esp
  while(--i >= 0)
    1046:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    104a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    104e:	79 d9                	jns    1029 <printint+0x86>
}
    1050:	90                   	nop
    1051:	90                   	nop
    1052:	c9                   	leave  
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    10b1:	e8 ca fe ff ff       	call   f80 <putc>
    ...
    10d5:	6a 0a                	push   $0xa
    10d7:	50                   	push   %eax
    10d8:	ff 75 08             	push   0x8(%ebp)
    10db:	e8 c3 fe ff ff       	call   fa3 <printint>
    ...
    1101:	50                   	push   %eax
    1102:	ff 75 08             	push   0x8(%ebp)
    1105:	e8 99 fe ff ff       	call   fa3 <printint>
    ...
    1143:	50                   	push   %eax
    1144:	ff 75 08             	push   0x8(%ebp)
    1147:	e8 34 fe ff ff       	call   f80 <putc>
    ...
    1170:	50                   	push   %eax
    1171:	ff 75 08             	push   0x8(%ebp)
    1174:	e8 07 fe ff ff       	call   f80 <putc>
    ...
    1191:	50                   	push   %eax
    1192:	ff 75 08             	push   0x8(%ebp)
    1195:	e8 e6 fd ff ff       	call   f80 <putc>
    ...
    11a4:	ff 75 08             	push   0x8(%ebp)
    11a7:	e8 d4 fd ff ff       	call   f80 <putc>
    ...
    11b8:	50                   	push   %eax
    11b9:	ff 75 08             	push   0x8(%ebp)
    11bc:	e8 bf fd ff ff       	call   f80 <putc>
...
free(void *ap)
{
    ...
    11e9:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11ec:	8b 45 08             	mov    0x8(%ebp),%eax
    11ef:	83 e8 08             	sub    $0x8,%eax
    11f2:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11f5:	a1 2c 1a 00 00       	mov    0x1a2c,%eax
    11fa:	89 45 fc             	mov    %eax,-0x4(%ebp)
    11fd:	eb 24                	jmp    1223 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11ff:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1202:	8b 00                	mov    (%eax),%eax
    1204:	39 45 fc             	cmp    %eax,-0x4(%ebp)
    1207:	72 12                	jb     121b <free+0x35>
    1209:	8b 45 f8             	mov    -0x8(%ebp),%eax
    120c:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    120f:	77 24                	ja     1235 <free+0x4f>
    1211:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1214:	8b 00                	mov    (%eax),%eax
    1216:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    1219:	72 1a                	jb     1235 <free+0x4f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    121b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    121e:	8b 00                	mov    (%eax),%eax
    1220:	89 45 fc             	mov    %eax,-0x4(%ebp)
    1223:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1226:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1229:	76 d4                	jbe    11ff <free+0x19>
    122b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    122e:	8b 00                	mov    (%eax),%eax
    1230:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    1233:	73 ca                	jae    11ff <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
    1235:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1238:	8b 40 04             	mov    0x4(%eax),%eax
    123b:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    1242:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1245:	01 c2                	add    %eax,%edx
    1247:	8b 45 fc             	mov    -0x4(%ebp),%eax
    124a:	8b 00                	mov    (%eax),%eax
    124c:	39 c2                	cmp    %eax,%edx
    124e:	75 24                	jne    1274 <free+0x8e>
    ...
    1272:	eb 0a                	jmp    127e <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    1274:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1277:	8b 10                	mov    (%eax),%edx
    1279:	8b 45 f8             	mov    -0x8(%ebp),%eax
    127c:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    127e:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1281:	8b 40 04             	mov    0x4(%eax),%eax
    1284:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    128b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    128e:	01 d0                	add    %edx,%eax
    1290:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    1293:	75 20                	jne    12b5 <free+0xcf>
    p->s.size += bp->s.size;
    1295:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1298:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    12ac:	8b 10                	mov    (%eax),%edx
    12ae:	8b 45 fc             	mov    -0x4(%ebp),%eax
    12b1:	89 10                	mov    %edx,(%eax)
    12b3:	eb 08                	jmp    12bd <free+0xd7>
  } else
    p->s.ptr = bp;
    12b5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    12b8:	8b 55 f8             	mov    -0x8(%ebp),%edx
    12bb:	89 10                	mov    %edx,(%eax)
  freep = p;
    12bd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    12c0:	a3 2c 1a 00 00       	mov    %eax,0x1a2c
}
    12c5:	90                   	nop
    12c6:	c9                   	leave  
    12c7:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    12cb:	83 ec 18             	sub    $0x18,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    12ce:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    12d5:	77 07                	ja     12de <morecore+0x16>
    nu = 4096;
    12d7:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    12de:	8b 45 08             	mov    0x8(%ebp),%eax
    12e1:	c1 e0 03             	shl    $0x3,%eax
    12e4:	83 ec 0c             	sub    $0xc,%esp
    12e7:	50                   	push   %eax
    12e8:	e8 73 fc ff ff       	call   f60 <sbrk>
    12ed:	83 c4 10             	add    $0x10,%esp
    12f0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    12f3:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    12f7:	75 07                	jne    1300 <morecore+0x38>
    return 0;
    12f9:	b8 00 00 00 00       	mov    $0x0,%eax
    12fe:	eb 26                	jmp    1326 <morecore+0x5e>
  hp = (Header*)p;
    1300:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1303:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    1306:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1309:	8b 55 08             	mov    0x8(%ebp),%edx
    130c:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    130f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1312:	83 c0 08             	add    $0x8,%eax
    1315:	83 ec 0c             	sub    $0xc,%esp
    1318:	50                   	push   %eax
    1319:	e8 c8 fe ff ff       	call   11e6 <free>
    131e:	83 c4 10             	add    $0x10,%esp
  return freep;
    1321:	a1 2c 1a 00 00       	mov    0x1a2c,%eax
}
    1326:	c9                   	leave  
    1327:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    1331:	83 c0 07             	add    $0x7,%eax
    1334:	c1 e8 03             	shr    $0x3,%eax
    1337:	83 c0 01             	add    $0x1,%eax
    133a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    133d:	a1 2c 1a 00 00       	mov    0x1a2c,%eax
    1342:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1345:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1349:	75 23                	jne    136e <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    134b:	c7 45 f0 24 1a 00 00 	movl   $0x1a24,-0x10(%ebp)
    1352:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1355:	a3 2c 1a 00 00       	mov    %eax,0x1a2c
    135a:	a1 2c 1a 00 00       	mov    0x1a2c,%eax
    135f:	a3 24 1a 00 00       	mov    %eax,0x1a24
    base.s.size = 0;
    1364:	c7 05 28 1a 00 00 00 	movl   $0x0,0x1a28
    136b:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
    1376:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1379:	8b 40 04             	mov    0x4(%eax),%eax
    137c:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    137f:	77 4d                	ja     13ce <malloc+0xa6>
      if(p->s.size == nunits)
    1381:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1384:	8b 40 04             	mov    0x4(%eax),%eax
    1387:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    138a:	75 0c                	jne    1398 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    138c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    138f:	8b 10                	mov    (%eax),%edx
    1391:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1394:	89 10                	mov    %edx,(%eax)
    1396:	eb 26                	jmp    13be <malloc+0x96>
      else {
        p->s.size -= nunits;
    1398:	8b 45 f4             	mov    -0xc(%ebp),%eax
    139b:	8b 40 04             	mov    0x4(%eax),%eax
    139e:	2b 45 ec             	sub    -0x14(%ebp),%eax
    ...
    13af:	c1 e0 03             	shl    $0x3,%eax
    13b2:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    13b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13b8:	8b 55 ec             	mov    -0x14(%ebp),%edx
    13bb:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    13be:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13c1:	a3 2c 1a 00 00       	mov    %eax,0x1a2c
      return (void*)(p + 1);
    13c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13c9:	83 c0 08             	add    $0x8,%eax
    13cc:	eb 3b                	jmp    1409 <malloc+0xe1>
    }
    if(p == freep)
    13ce:	a1 2c 1a 00 00       	mov    0x1a2c,%eax
    13d3:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    13d6:	75 1e                	jne    13f6 <malloc+0xce>
      if((p = morecore(nunits)) == 0)
    13d8:	83 ec 0c             	sub    $0xc,%esp
    13db:	ff 75 ec             	push   -0x14(%ebp)
    13de:	e8 e5 fe ff ff       	call   12c8 <morecore>
    13e3:	83 c4 10             	add    $0x10,%esp
    13e6:	89 45 f4             	mov    %eax,-0xc(%ebp)
    13e9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    13ed:	75 07                	jne    13f6 <malloc+0xce>
        return 0;
    13ef:	b8 00 00 00 00       	mov    $0x0,%eax
    13f4:	eb 13                	jmp    1409 <malloc+0xe1>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    13f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13f9:	89 45 f0             	mov    %eax,-0x10(%ebp)
    13fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13ff:	8b 00                	mov    (%eax),%eax
    1401:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    1404:	e9 6d ff ff ff       	jmp    1376 <malloc+0x4e>
  }
}
    1409:	c9                   	leave  
    140a:	c3                   	ret    
